...
public class SonMakeWindow {
	...
	public void addTip() {
		...
		player.showFormWindow(new FormWindowCustom(Tool.getColorFont(getTitle()) + TextFormat.WHITE + "-Tip", list,
	...
	public void addCommand() {
		...
		player.showFormWindow(new FormWindowCustom(Tool.getColorFont(getTitle()) + TextFormat.WHITE + "-命令", list,
	...
	public void addTransfer() {
		...
		list.add(new ElementInput(TextFormat.WHITE + "请输入贴图路径",
				"例如：http://10086.sb/10010.png 或 石头 或 textures/blocks/sapling_jungle.png", sb));
		player.showFormWindow(new FormWindowCustom(Tool.getColorFont(getTitle()) + TextFormat.WHITE + "-传送", list),
	...
	public void addOpenShop() {
		...
		player.showFormWindow(
				new FormWindowCustom(Tool.getColorFont(getTitle()) + TextFormat.WHITE + "-Open Show", list),
	...
	public void addOpenWindows() {
		...
		list.add(new ElementInput(TextFormat.WHITE + "请输入贴图路径",
				"例如：http://10086.sb/10010.png、石头 或 textures/blocks/sapling_jungle.png", sb));
		player.showFormWindow(new FormWindowCustom(Tool.getColorFont(getTitle()) + TextFormat.WHITE + "-Open", list),
